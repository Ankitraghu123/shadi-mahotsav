...
import { allAutoPools, getAllFranchise } from '../Features/Franchise/FranchiseSlice';

const AllAutoPoolsFranchises = () => {
  const dispatch = useDispatch();
  const franchises = useSelector((state) => state.Franchise?.allAutoPoolsFranchise?.franchises);
  useEffect(() => {
    dispatch(allAutoPools());
  }, []);
        ...
        <table className="table table-striped table-bordered table-hover">
          <thead className="table-dark">
            <tr>
              ...
              <th className="text-nowrap">Upline Of</th>
          ...
          <tbody>
            {currentEntries?.map((franchise) => (
              <tr key={franchise.user_id}>
                ...
                <td className="text-nowrap">{franchise?.uplineOf?.code}</td>
...
export default AllAutoPoolsFranchises;
